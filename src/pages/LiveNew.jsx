        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-5.5">
            <div className="bg-red100 rounded-lg py-2 px-4 flex items-center gap-2">
              ...
              <p className="text-sm font-semibold uppercase text-white">LIVE</p>
            </div>
          ...
          <button className="bg-red100 rounded-lg py-2 px-4 flex items-center gap-2 text-sm text-white">
            {" "}
            <IoMdClose className="w-4 h-4" /> End Live
          </button>
        </div>
        <div className="flex flex-col gap-3">
          <h2 className="text-2xl font-bold text-white">Welcome to my Live</h2>

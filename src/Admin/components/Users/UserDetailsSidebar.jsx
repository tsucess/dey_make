    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 w-full max-w-[450px] bg-blue400 border-l border-black300 shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out translate-x-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 pt-0 font-inter" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
            ...
            <div className="relative">
              ...
              {user.verified && (
                <div className="absolute bottom-0 right-0 bg-blue200 rounded-full p-0.5">
                  <MdVerified className="w-6 h-6 text-cyan200" />
                </div>
              )}
            </div>
            <h2 className="text-lg font-semibold text-white mt-4">{user.name}</h2>
            <p className="text-sm text-slate400 mb-6">{user.username}</p>

            <div className="flex items-center gap-8 mb-6">
              <div className="flex flex-col items-center gap-1">
                <span className="text-white font-semibold">134</span>
                <span className="text-slate400 text-xs">Videos</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-white font-semibold">1.5M</span>
                <span className="text-slate400 text-xs">Followers</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-white font-semibold">100</span>
                <span className="text-slate400 text-xs">Following</span>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <div className="bg-[#2A2A2A] text-slate300 px-4 py-2 rounded-md text-xs flex items-center gap-2 font-medium">
                <FaHeart className="text-red500 w-3.5 h-3.5" /> 2.4M total likes
              </div>
              <div className="bg-green500/10 text-green500 border border-green500/20 px-8 py-2 rounded-md text-xs font-medium">
                Active
              </div>
            </div>
          </div>
          ...
          {/* Tabs */}
          <div className="flex border-b border-black300/50 mb-6">
          ...
          <div className="bg-blue300 rounded-xl p-5 mb-5 border border-black300/50">
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">User ID</span>
                <span className="text-white text-xs font-medium">{user.id}</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Email Address</span>
                <span className="text-white text-xs font-medium">zara@gmail.com</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Phone Number</span>
                <span className="text-white text-xs font-medium">08100000000</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Country/Region</span>
                <span className="text-white text-xs font-medium">{user.country || "Nigeria"}</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Joined Date</span>
                <span className="text-white text-xs font-medium">{user.joinedDate}</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Last Active</span>
              ...
              <div className="flex justify-between items-center py-4 pt-4">
                <span className="text-slate300 text-xs font-medium">Device</span>
          ...
          <div className="bg-blue300 rounded-xl p-5 mb-5 border border-black300/50">
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Status</span>
                <span className="text-white text-xs font-medium">{user.status}</span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Verification</span>
                <span className="text-[#3b82f6] text-xs font-medium flex items-center gap-1">
                  Verified Creator <MdVerified className="w-3.5 h-3.5" />
                </span>
              </div>
              <div className="flex justify-between items-center py-4 border-b border-black300">
                <span className="text-slate300 text-xs font-medium">Account Health</span>
                <span className="text-green500 text-xs font-medium">Good</span>
              </div>
              <div className="flex justify-between items-center py-4 pt-4">
                <span className="text-slate300 text-xs font-medium">Restrictions</span>
          ...
          {/* Account Actions */}
          <div className="bg-blue300 rounded-xl p-5 pb-6 border border-black300/50">
            <h3 className="text-sm font-medium text-white mb-4">Account Status</h3>
            
            <div className="grid grid-cols-2 gap-3 mb-3">
              <button className="flex items-center justify-center gap-2 py-2.5 bg-transparent border border-slate700 rounded-md text-slate300 text-xs font-medium hover:bg-black300 transition-colors">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              <button className="flex items-center justify-center gap-2 py-2.5 bg-transparent border border-orange500/30 rounded-md text-orange500 text-xs font-medium hover:bg-orange500/10 transition-colors">
                <FiDownload className="w-3.5 h-3.5" /> Suspended Account
              </button>
              <button className="flex items-center justify-center gap-2 py-2.5 bg-transparent border border-red500/30 rounded-md text-red500 text-xs font-medium hover:bg-red500/10 transition-colors">
                <FiXCircle className="w-3.5 h-3.5" /> Ban Account
              </button>
            </div>

            <button className="w-full flex items-center justify-center gap-2 py-2.5 bg-transparent border border-slate700 rounded-md text-slate300 text-xs font-medium hover:bg-black300 transition-colors">

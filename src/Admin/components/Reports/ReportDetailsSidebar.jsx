...
export default function ReportDetailsSidebar({ report, onClose }) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 h-full w-full sm:w-[450px] bg-[#0b1011] border-l border-zinc-800 z-50 flex flex-col font-inter overflow-y-auto transform transition-transform translate-x-0">
        <button 
          onClick={onClose}
        ...
        <div className="relative h-[250px] w-full bg-zinc-900 shrink-0">
          <img 
            src="/story3.jpg" 
            alt="Content preview" 
        ...
        <div className="p-6 flex flex-col gap-6">
          <div className="flex flex-col gap-1 -mt-2">
            ...
            <p className="text-sm text-slate-400">by Goria James</p>
            <p className="text-xs text-slate-500">ID: LIVE-2026-00132</p>
          </div>

          {/* Report Information */}
          <div className="flex flex-col gap-4 bg-[#131313] border border-zinc-800 rounded-xl p-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-[#131313] border border-zinc-800 rounded-xl p-4 text-sm text-slate-300">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between bg-[#131313] border border-zinc-800 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <FiDownload className="text-slate-400 w-5 h-5" />
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-white">Screenshots</span>
                    <span className="text-xs text-slate-500">JPG - 2.6 MB</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <textarea 
              ...
              className="bg-[#131313] border border-zinc-800 rounded-xl p-4 text-sm text-white placeholder-slate-500 outline-none resize-none h-24 focus:border-zinc-600 transition-colors"
            />
          </div>
          ...
          <div className="flex flex-col gap-3 mt-2 pb-6">
            ...
            <button className="flex items-center justify-center gap-2 w-full py-3.5 rounded-lg border border-zinc-700 text-white text-sm font-medium hover:bg-zinc-800 transition-colors">
              <FiEye className="w-4 h-4" /> Warn Streamer
            </button>
            <button className="flex items-center justify-center gap-2 w-full py-3.5 rounded-lg border border-red-500/30 text-red-500 text-sm font-medium hover:bg-red-500/10 transition-colors">

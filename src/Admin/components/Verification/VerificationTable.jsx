          ...
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div key={i} className="grid grid-cols-12 gap-4">
              ...
              <div className="flex items-center gap-1 col-span-3">
                <img src="/aisha.png" alt="" className="w-10 h-10 rounded-full object-contain"/>
              ...
              <p className="text-sm font-light text-white col-span-1">
                Lifestyle
              </p>
              <p className="text-sm font-light text-white col-span-1">
                2.4M
              </p>
              <p className="text-sm font-light text-white col-span-2">
                2 hours ago
              </p>
              ...
              <button className="col-span-1"><FaEllipsisVertical className="w-4 h-4 text-white" /></button>
            </div>
          ))}
        </div>
      </div>

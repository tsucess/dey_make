  ...
  return (
    <div className="flex flex-col gap-4 w-full md:w-1/3">
        <div className="border-y border-black dark:border-white py-4 flex items-center justify-between px-4">
            <h3 className="text-xl font-inter text-black dark:text-white">90 Comments</h3>
        ...
        <div className="h-full flex flex-col gap-8">
                    ...
                    comments.map(({img, name, time, desc, likes, dislikes, replies }, i) => <div key={i} className="flex gap-4 items-start">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button className="text-black dark:text-white text-sm font-inter">Reply</button>
                            </div>
                            {
                                replies > 0 && <div className="flex items-center gap-2 text-orange100 text-sm"> <MdOutlineKeyboardArrowDown className="w-5 h-5" /> Replies</div>
                            }
                        </div>
                    </div>)
                }
            ...
            <div className="mt-auto flex items-center py-3 px-4 rounded-full w-full gap-3 bg-slate150 dark:bg-black100 max-h-17.5 h-full">
                <img src="/user1.jpg" alt="" className="w-7 h-7 rounded-full shrink-0" />
                <input type="text" name="" id="" className="text-sm font-inter text-black dark:text-white flex-1" placeholder="Tell the creator what you think!" />
            </div>
        </div>
    </div>
  )

  ...
  return (
    <div className="p-5 flex flex-col gap-6 border border-black300 dark:border-white rounded-3xl">
      ...
      <div className="flex flex-col gap-6">
        {
            videos.map(({title, views, likes, comment, time, engagement}, i) => <div key={i} className="flex flex-col  md:items-center md:justify-between gap-2">
                <div className="flex items-center gap-3">
                    <div className="w-10 md:w-18.25 h-10 md:h-18.25 rounded-md bg-slate400 dark:bg-white shrink-0"></div>
                    <div className="flex flex-col justify-between gap-1 font-inter">
                        <h5 className="text-sm md:text-base font-bold text-black dark:text-white">{title}</h5>
                        <div className="flex items-center gap-3">

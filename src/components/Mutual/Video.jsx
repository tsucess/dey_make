...
function MediaFit({ src, poster, type, alt }) {
  ...
  return (
    <img
      src={(!isVideo && src) || poster || "/friend.jpg"}
      alt={alt || ""}
...
function Video({
  ...
  const mediaSrc = getVideoStreamUrl(video) || getVideoMediaUrl(video) || "/friend.jpg";
  const thumbnail = video ? getVideoThumbnail(video) : "/friend.jpg";

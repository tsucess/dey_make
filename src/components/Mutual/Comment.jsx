              ...
              <div key={id ?? i} className="flex gap-4 items-start">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      type="button"
                      onClick={() => !isStatic && onToggleLike && onToggleLike(id, liked)}
                    ...
                    <button
                      type="button"
                      onClick={() => !isStatic && onToggleDislike && onToggleDislike(id, disliked)}
                      className="flex items-center gap-2"
                    >
                      {disliked ? (
                    ...
                    <button
                      type="button"
                      onClick={() => !isStatic && toggleReplyComposer(id)}
                      className="text-black dark:text-white text-sm font-inter"
                    >
                      Reply
                    </button>
                  </div>
                  ...
                  {replies > 0 && (
                    <button
                      type="button"
                      onClick={() => !isStatic && toggleReplies(id)}
                      className="flex items-center gap-2 text-orange100 text-sm"
                    >
                      {" "}
                      {isExpanded ? (
            ...
            <div className="absolute bottom-full mb-2 left-0 right-0 bg-white dark:bg-black100 rounded-2xl border border-slate150 p-3 grid grid-cols-8 gap-2 z-10">
              {EMOJI_SET.map((emoji) => (
                <button
                  ...
                  className="text-xl hover:bg-slate150 dark:hover:bg-black rounded"
                >
                  {emoji}
                </button>
              ))}

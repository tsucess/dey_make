...
export default function TopBar({ notificationState = null }) {
  ...
  const internalNotificationState = useNotifications({ enabled: !notificationState });
  const {
    isNotificationOpen,
    openNotification,
    closeNotification,
  ...
  const shouldRenderManagedNotificationUi = !notificationState;
  ...
  return (
    <>
    {shouldRenderManagedNotificationUi ? (
      <>

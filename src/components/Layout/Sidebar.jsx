...
export default function Sidebar({ isSidebarOpen, setIsSidebarOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex flex-col w-67.5 min-h-screen bg-white dark:bg-black300 border-r pb-15 lg:pb-0 border-orange100 shrink-0 transform transition-transform duration-300 lg:relative lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
